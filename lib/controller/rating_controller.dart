...
import 'package:cabme/model/review_list_model.dart';
...
class RatingController extends GetxController {
  ...
  Future<void> getReview() async {
    ...
    await API
      ...
      (value) {
        if (value != null) {
          ReviewModel model = ReviewModel.fromJson(value);
          if (model.success == "success" || model.success == "Success") {
            rating.value = double.parse(model.data!.rating.toString());
            ratingController.value.text = model.data!.comment.toString();
          }
        }
      },
    );
