...
import 'package:latlong2/latlong.dart' as location show LatLng;
...
class ParcelDetailsController extends GetxController {
  ...
  List<LatLng> get osmPoints => locationData.map((e) => LatLng(double.parse(e.latitude ?? '0.1'), double.parse(e.longitude ?? '0.1'))).toList();
