...
class Data {
  ...
  String? isCustomerMaintenanceMode;
  ...
  Data(
      ...
      this.isCustomerMaintenanceMode,
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    isCustomerMaintenanceMode = json['is_customer_maintenance_mode'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_customer_maintenance_mode'] = isCustomerMaintenanceMode;
