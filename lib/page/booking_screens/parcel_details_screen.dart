...
import 'package:cabme/widget/parcel_map_view.dart';
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    controller.parcelBookingData.value.status == RideStatus.canceled || controller.parcelBookingData.value.status == RideStatus.rejected
                        ? SizedBox()
                        : Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  controller.parcelBookingData.value.status == RideStatus.newRide
                                      ? Text(
                                          "Waiting for driver to accept...".tr,
                                          style: AppThemeData.semiBoldTextStyle(
                                              fontSize: 16,
                                              color: themeChange.getThem() ? AppThemeData.successDarkDark : AppThemeData.successDefault),
                                        )
                                      : controller.parcelBookingData.value.driver == null
                                          ? Text(
                                              "Ride cancelled by driver".tr,
                                              style: AppThemeData.semiBoldTextStyle(
                                                  fontSize: 16,
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    Constant.makePhoneCall(
                                                                        controller.parcelBookingData.value.driver!.phone!);
                                                                  },
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    Get.to(ConversationScreen(), arguments: {
                                                                      "receiverId": controller.parcelBookingData.value.driver!.id,
                                                                      "orderId": controller.parcelBookingData.value.id,
                                                                      "receiverName":
                                                                          "${controller.parcelBookingData.value.driver!.prenom} ${controller.parcelBookingData.value.driver!.nom}",
                                                                      "receiverPhoto": controller.parcelBookingData.value.driver!.image
                                                                    });
                                                                  },
                                                                  child: SvgPicture.asset(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () {
                                                      Get.to(RatingScreen(), arguments: {
                                                        "bookingType": "parcel",
                                                        "parcelBookingModel": controller.parcelBookingData.value
                                                      })!
                                                          .then(
                                                        (value) {
                                                          if (value != null) {
                              ...
                              child: Row(
                                children: [
                                  ...
                                  controller.parcelBookingData.value.status == RideStatus.confirmed ||
                                      ...
                                      ? InkWell(
                                          onTap: () {
                                            Constant.makePhoneCall(controller.parcelBookingData.value.senderPhone.toString());
                                          },
                                          child: SvgPicture.asset(
                                            "assets/icons/ic_phone_dial.svg",
                                            width: 36,
                              ...
                              child: Row(
                                children: [
                                  ...
                                  controller.parcelBookingData.value.status == RideStatus.confirmed ||
                                      ...
                                      ? InkWell(
                                          onTap: () {
                                            Constant.makePhoneCall(controller.parcelBookingData.value.receiverPhone.toString());
                                          },
                                          child: SvgPicture.asset(
                                            "assets/icons/ic_phone_dial.svg",
                                            width: 36,
