...
class WalletScreen extends StatelessWidget {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image:
                                    AssetImage(themeChange.getThem() ? "assets/images/wallet_bg_dark.png" : "assets/images/wallet_bg.png"),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style: AppThemeData.boldTextStyle(
                                        fontSize: 36, color: themeChange.getThem() ? AppThemeData.neutralDark900 : AppThemeData.neutral900),
                                  ),
                                  SizedBox(height: 30),
                                  RoundedButtonFill(
                                  ...
                                  child: controller.transactionList.isEmpty
                                      ...
                                      : Padding(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemCount: controller.transactionList.length, // Replace with your transaction history length
  ...
  Widget cardDecoration(WalletController controller, String value, themeChange, String image) {
    return Obx(
      () => InkWell(
        onTap: () {
                          ...
                          children: [
                            ...
                            Text(
                              'balanceWithAmount'.trParams({
                                'amount': Constant().amountShow(amount: "100"),
                              }),
                              style: AppThemeData.semiBoldTextStyle(
